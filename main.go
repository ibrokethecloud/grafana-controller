...
import (
	...
	"github.com/ibrokethecloud/grafana-controller/controllers"
...
func main() {
	...
	apiClient := grafana.NewAPIClient(grafanaEndpoint, grafanaToken)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "e5094ccc.grafana.io",
	})
	if err != nil {
